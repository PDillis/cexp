...
def check_benchmarked_environments(json_filename, agent_checkpoint_name):
    ...
    if not os.path.exists(os.path.join(os.environ["COIL_DATASET_PATH"], json_file['package_name'])):
...
def add_summary(environment_name, summary, json_filename, agent_checkpoint_name):
    ...
    filename = os.path.join(os.environ["COIL_DATASET_PATH"], json_file['package_name'],
...
def benchmark_cleanup(package_name, agent_checkpoint_name):
    ...
    shutil.rmtree(os.environ["COIL_DATASET_PATH"], package_name,
