...
def check_folder(env_name, number_episodes):
    ...
    path = os.path.join(os.environ["COIL_DATASET_PATH"], 'sample_benchmark', env_name)
...
def test_2_construct():
    ...
    path = os.path.join(os.environ["COIL_DATASET_PATH"], 'sample_benchmark', 'WetSunset_route00024', '0')

    os.makedirs(path)

    path = os.path.join(os.environ["COIL_DATASET_PATH"], 'sample_benchmark', 'SoftRainSunset_route00000', '0')
...
if __name__ == '__main__':
    ...
    if os.path.exists(os.path.join(os.environ["COIL_DATASET_PATH"], 'sample_benchmark')):
        shutil.rmtree(os.path.join(os.environ["COIL_DATASET_PATH"], 'sample_benchmark'))
