...
def check_folder(env_name, number_episodes):
    ...
    path = os.path.join(os.environ["COIL_DATASET_PATH"], 'sample_benchmark_background', env_name)
...
if __name__ == '__main__':
    ...
    if os.path.exists(os.path.join(os.environ["COIL_DATASET_PATH"], 'sample_benchmark_background')):
        shutil.rmtree(os.path.join(os.environ["COIL_DATASET_PATH"], 'sample_benchmark_background'))
