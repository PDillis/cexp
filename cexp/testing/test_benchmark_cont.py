...
def check_folder(env_name, number_episodes):
    ...
    path = os.path.join(os.environ["COIL_DATASET_PATH"], 'sample_benchmark2', env_name)
...
def summarize_benchmark(benchmark_name, agent_name, checkpoint):
    ...
    for env_name in json_file['envs'].keys():
        ...
        path = os.path.join(os.environ["COIL_DATASET_PATH"],  json_file['package_name'], env_name,
    ...
    outfile_name = os.path.join(os.environ["COIL_DATASET_PATH"], json_file['package_name'],
...
if __name__ == '__main__':
    ...
    #if os.path.exists(os.path.join(os.environ["COIL_DATASET_PATH"], 'sample_benchmark2')):
    #    shutil.rmtree(os.path.join(os.environ["COIL_DATASET_PATH"], 'sample_benchmark2'))
